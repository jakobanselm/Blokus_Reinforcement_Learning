...
def env_creator(config=None):
    return BlokusMultiAgentEnvV3()


register_env("blokus_ma_v3", env_creator)
...
def main():
    ...
    policies = {pid: (None, obs_space, act_space, {}) for pid in temp_env.agent_ids}
    ...
    checkpoint = algo.save("rllib_multiagent_v3")
